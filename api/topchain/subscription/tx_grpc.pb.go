...
const (
	...
	Msg_SubmitObfuscatedProgress_FullMethodName = "/topchain.subscription.Msg/SubmitObfuscatedProgress"
)
...
func (c *msgClient) SubmitObfuscatedProgress(ctx context.Context, in *MsgSubmitObfuscatedProgress, opts ...grpc.CallOption) (*MsgSubmitObfuscatedProgressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SubmitObfuscatedProgress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SubmitObfuscatedProgress(context.Context, *MsgSubmitObfuscatedProgress) (*MsgSubmitObfuscatedProgressResponse, error) {
...
func _Msg_SubmitObfuscatedProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SubmitObfuscatedProgress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
