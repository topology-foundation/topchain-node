...
const (
	Query_Params_FullMethodName = "/topchain.challenge.Query/Params"
	Query_Proof_FullMethodName  = "/topchain.challenge.Query/Proof"
	Query_Proofs_FullMethodName = "/topchain.challenge.Query/Proofs"
)
...
func (c *queryClient) Proofs(ctx context.Context, in *QueryProofsRequest, opts ...grpc.CallOption) (*QueryProofsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Proofs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
