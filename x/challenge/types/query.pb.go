...
func init() {
	...
	proto.RegisterType((*QueryProofRequest)(nil), "topchain.challenge.QueryProofRequest")
	proto.RegisterType((*QueryProofResponse)(nil), "topchain.challenge.QueryProofResponse")
	proto.RegisterType((*QueryProofsRequest)(nil), "topchain.challenge.QueryProofsRequest")
	proto.RegisterType((*QueryProofsResponse)(nil), "topchain.challenge.QueryProofsResponse")
}
...
func (c *queryClient) Proof(ctx context.Context, in *QueryProofRequest, opts ...grpc.CallOption) (*QueryProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/topchain.challenge.Query/Proof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Proofs(ctx context.Context, in *QueryProofsRequest, opts ...grpc.CallOption) (*QueryProofsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/topchain.challenge.Query/Proofs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Proof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/topchain.challenge.Query/Proof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Proofs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/topchain.challenge.Query/Proofs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
