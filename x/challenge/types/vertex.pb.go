...
func init() {
	proto.RegisterType((*Vertex)(nil), "topchain.challenge.Vertex")
	proto.RegisterType((*Vertex_Operation)(nil), "topchain.challenge.Vertex.Operation")
}

func init() { proto.RegisterFile("topchain/challenge/vertex.proto", fileDescriptor_8a1d31e59334e75c) }
