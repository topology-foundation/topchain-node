...
func TestQueryDeal(t *testing.T) {
	...
	require.EqualValues(t, createDeal, types.MsgCreateDeal{Requester: queryResponse.Deal.Requester, CroId: queryResponse.Deal.CroId, Amount: queryResponse.Deal.TotalAmount, NumEpochs: queryResponse.Deal.NumEpochs, EpochSize: queryResponse.Deal.EpochSize})
}
...
func TestQueryDeals(t *testing.T) {
	...
	// Create a first deal
	createDeal1 := types.MsgCreateDeal{Requester: Alice, CroId: "alicecro1", Amount: 1000, NumEpochs: 10, EpochSize: 20}
	...
	createDeal2 := types.MsgCreateDeal{Requester: Alice, CroId: "alicecro2", Amount: 1000, NumEpochs: 20, EpochSize: 30}
	...
	// Create a third deal
	createDeal3 := types.MsgCreateDeal{Requester: Alice, CroId: "alicecro", Amount: 1000, NumEpochs: 10, EpochSize: 20}
