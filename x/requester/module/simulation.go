...
import (
	...
	requestersimulation "topchain/x/requester/simulation"
	"topchain/x/requester/types"
)

// avoid unused import issue
var (
	_ = requestersimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	requesterGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&requesterGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		requestersimulation.SimulateMsgRequestSubscription(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		requestersimulation.SimulateMsgCancelSubscription(am.accountKeeper, am.bankKeeper, am.keeper),
	))
